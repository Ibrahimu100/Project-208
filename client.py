...
def openChatWindow():
    ...
    connectserver = Button(window,text="Login",bd=1, font = ("Calibri",10))
    connectserver.place(x=350,y=6)

    separator = ttk.Separator(window, orient='horizontal')
    separator.place(x=0, y=35, relwidth=1, height=0.1)

    labelusers = Label(window, text= "Select Song:", font = ("Calibri",10))
    ...
    labelchat = Label(window, text="Playlists", font = ("Calibri", 10))
    labelchat.place(x=10,y=200)
    ...
    attach = Button(window,text="Song:", bd=1, font = ("Calibri",10))
    ...
    send= Button(window,text="Download", bd=1, font = ("Calibri",10))
